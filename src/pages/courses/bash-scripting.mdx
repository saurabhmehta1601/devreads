...
<CoursePage  title = {"BASH Scripting"} breakpoints = {[{"Introduction": ["Getting started"]}, {"Features": ["Comments", "Useful Techniques", "Conditional Statements", "Logical Operators"]}]} 
>

<Section data-name="Getting started">
...
Note: When you are done giving input press Ctrl-c on terminal to stop giving input .
...
This will make a file output.txt as well as add script program output (STDOUT) to output.txt
