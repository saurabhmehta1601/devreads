...
<CoursePage title ={"Testing for Web Apps"}  breakpoints = {[{ "Introduction": ["Intro to Testing", "Testing Techniques"] }] } > 

<Section data-name="Intro to Testing">
...
<Section data-name="Testing Techniques">
